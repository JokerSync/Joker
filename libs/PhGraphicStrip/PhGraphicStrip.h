...
public:
	 ...
	 * @param nextTextAreaX The horizontal position where the next text are displayed
	 * @param nextTextAreaY The vertical position where the next text are displayed
