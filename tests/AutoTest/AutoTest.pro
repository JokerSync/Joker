...
QMAKE_POST_LINK += $${QMAKE_COPY} $$shell_path($${_PRO_FILE_PWD_}/../../data/strip/drb01.drb) . $${CS}
QMAKE_POST_LINK += $${QMAKE_COPY} -r $$shell_path($${_PRO_FILE_PWD_}/../../data/strip/drb01) . $${CS}
